    ...
    return (
      <Fragment>
        <Container className="text-center" fluid={true}>
          <div className="section-title text-center mb-55"><h2>CATEEGORIES</h2>
            <p>Some Of Our Exclusive Collection, You May Like</p>
          </div>
          <Row>
            <Col className='p-1' key={1} xl={6} lg={6} sm={12} xs={12}>
              <Row>
              <Col className="p-0" key={1} xl={3} lg={3} sm={6} xs={6}>
